...
function Donate() {
  return (
    ...
    <div className="aboutBottom">
      <h1>Donate us</h1>
      <p><strong><h1>Terms and Conditions</h1></strong></p>
  ...
  <ul>
      ...
      <li>By sending us an email: wecarefoundations@gmail.com</li>
  </ul>
  <p></p>
  ...
  <div class="container">
      <a href="https://rzp.io/l/KNn1HqaBR">
      <button type="button" class="active btn btn-success" >Check Out</button>
      </a>
  </div>
    </div>
    </div>
